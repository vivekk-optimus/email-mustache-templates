/**
 * SaleCreatedTpl.js
 * @description :: Email template will be used when a sales order is created.
 * 
...
module.exports = {
    subject: `New {{portal_name}} Sales Order - {{order_name}} ({{brand}})`,
    content: `
    <section class='email-header'>
        <article id='order-heading' style='font-size: 16px; padding: 10px'>Sales order {{order_no}} for {{customer}} was successfully created.</article>
